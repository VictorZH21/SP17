...
namespace СП17
{
    public partial class Form1 : Form
    {
        ...
        private void RefreshProcessesList()
        {
            ...
            Text = "Process active : " + processes.Count.ToString();
        }
        ...
        private void RefreshProcessesList(List<Process> processes, string keyword)
        {
            ...
            Text = $"Process active: '{keyword}': " + processes.Count.ToString();
        }
        ...
        private void endTreeProcessToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (listView1.SelectedItems[0] != null)
